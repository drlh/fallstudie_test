...
public class mockGUI extends JFrame
{
	...
	contentPane.setBorder(new BevelBorder(BevelBorder.RAISED, null, null,
		null, null));
	...
	JLabel lblTitleStart = new JLabel(
		"Herzlich willkommen beim Unternehmensplanspiel \"Apfelweinkelterei\"");
	...
	panUnternehmen
		.setLayout(new BoxLayout(panUnternehmen, BoxLayout.X_AXIS));
	...
	panLieferanten
		.setLayout(new BoxLayout(panLieferanten, BoxLayout.X_AXIS));
